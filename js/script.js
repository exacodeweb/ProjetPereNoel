...
/*https://codepen.io/jeeve/pen/GrKNpN*/
var snow = {
  wind: 0,
  maxXrange: 100,
  minXrange: 10,
  ...
  color: "#fff",
  char: "*",
  maxSize: 22 /*20*/ /*taille maxi des flocons*/,
  minSize: 10 /*8*/ /*taille mini des flocons*/,
...
function reboursF() {
  ...
  if (total_secondes > 0) {
    ...
    let nb_heures = Math.floor(
      (total_secondes - nb_jours * 60 * 60 * 24) / (60 * 60)
    );
    let nb_minutes = Math.floor(
      (total_secondes - (nb_jours * 60 * 60 * 24 + nb_heures * 60 * 60)) / 60
    );
